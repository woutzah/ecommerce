package com.blockken.ecom.order.infrastructure.secondary.entity;

import com.blockken.ecom.order.domain.user.aggregate.User;
import com.blockken.ecom.order.domain.user.aggregate.UserBuilder;
import com.blockken.ecom.order.domain.user.vo.*;
import com.blockken.ecom.shared.jpa.AbstractAuditingEntity;
